...
import pt.ulisboa.tecnico.softeng.activity.services.remote.dataobjects.RestActivitiesNameData;
...
public class ActivityInterface {
	...
	public RestActivitiesNameData getActivitiesNames() {
		List<String> names = new ArrayList<>();

		for(ActivityProviderData provider: getProviders())
			for(ActivityData data: provider.getActivities())
				names.add(data.getName());

		return new RestActivitiesNameData(names);
	}
