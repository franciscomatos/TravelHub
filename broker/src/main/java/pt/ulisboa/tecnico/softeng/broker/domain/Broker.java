...
public class Broker extends Broker_Base {
    ...
    public BulkRoomBooking getBulkRoomBookingById(String id) {
        for (BulkRoomBooking bulk : getRoomBulkBookingSet()) {
            if (bulk.getId().equals(id)) {
                return bulk;
            }
        }
        return null;
    ...
    public RestActivitiesNameData getActivities() {
        return this.getActivityInterface().getActivities();
    }

    public RestHotelsNamesData getHotels() {
        return this.getHotelInterface().getHotels();
    }
