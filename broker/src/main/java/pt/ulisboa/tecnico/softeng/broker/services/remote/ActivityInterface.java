...
public class ActivityInterface {
    ...
    public RestActivitiesNameData getActivities() {
        ...
        try {
            return restTemplate.getForObject(
                    ENDPOINT + "/rest/providers/list", RestActivitiesNameData.class);
        } catch (HttpClientErrorException e) {
            logger.info("getActivitiesNames HttpClientErrorException");
            throw new ActivityException();
        } catch (Exception e) {
            logger.info("getActivitiesNames Exception");
            throw new RemoteAccessException();
        }
    }
