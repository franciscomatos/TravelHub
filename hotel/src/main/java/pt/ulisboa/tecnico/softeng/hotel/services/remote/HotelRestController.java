...
import pt.ulisboa.tecnico.softeng.hotel.services.remote.dataobjects.RestHotelsNamesData;
...
public class HotelRestController {
	...
	public ResponseEntity<RestHotelsNamesData> names() {
		logger.info("list");
		try {
			return new ResponseEntity<>(hi.getHotelsNames(), HttpStatus.OK);
